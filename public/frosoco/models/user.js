 ...
 * [Frosoco.Models.User.static.findAll retrieving],
 * [Frosoco.Models.User.static.update updating],
 * [Frosoco.Models.User.static.destroy destroying], and
 * [Frosoco.Models.User.static.create creating] users.
 */
$.Model.extend('Frosoco.Models.User',
/* @Static */
{
	/**
	...
	findAll: function( params, success, error ){
		$.ajax({
			...
			error: error,
			fixture: "//frosoco/fixtures/users.json.get" //calculates the fixture path from the url and type.
		});
	},
	/**
